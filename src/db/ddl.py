...
with open(os.path.join(PATH, "sql", "_update_user_activity.sql")) as sql:
    update_user_activity = DDL(sql.read())
with open(os.path.join(PATH, "sql", "trigger_update_user_activity.sql")) as sql:
    trigger_update_user_activity = DDL(sql.read())
with open(os.path.join(PATH, "sql", "_succesful_pay.sql")) as sql:
    succesful_pay = DDL(sql.read())
with open(os.path.join(PATH, "sql", "trigger_succesful_pay.sql")) as sql:
