...
def get_rate_descr(rate: int):
    ...
    match rate:
        ...
        case 0.3:
            descr = (
                "<b>Тариф: Пробный</b>"
                "\nМожет быть подключен <b>единоразово</b>. Подключение другого тарифа лишает пользователя возможности подключить этот тариф. "
                "Позволяет опробовать функционал подключения к VPN сервису. Доступно создание 1 конфигурации (1 устройство). "
                + general_2
            )
        case 1:
            descr = (
                "<b>Тариф: ⭐️Базовый⭐️</b>"
                "\nПозволяет получить доступ к базовому функционалу VPN сервиса. Доступно создание 3 конфигураций (3 устройства). "
                + general_2
                + f"\nАктуальная стоимость тарифа: <b>{get_plural(settings.cost * rate, 'рубль, рубля, рублей')} в день</b>."
                + general_1
            )
        case 2.5:
            descr = (
                ...
                "(Доступны различные инструменты анализа работы VPN сервиса, возможность отключать ненужные уведомления и т.д). "
