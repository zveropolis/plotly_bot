...
WG_STEPS = {
    ...
    - Найдите приложение "WireGuard" и скачайте его (либо скачайте на официальном сайте WireGuard https://www.wireguard.com/install/).
    - В случае некорректной работы оригинального приложения воспользуйтесь альтернативным клиентом: 'WG Tunnel':
    ...
    - Откройте приложение WireGuard (WG Tunnel).
